...
// connect to database
$db = mysqli_connect('localhost', 'root', '', 'oneopti_db');
...
function register(){
	...
	// Form validation: Check if Username and Email already exist
...
// LOGIN USER 
   ...
   * is called which logs the user in. Notice that when the user is logged in, it also 
   * does a check: if the user is admin, it redirects them to the 
